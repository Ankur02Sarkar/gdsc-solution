...
const Register = () => {
  return (
    <section class="yjGyQxv8jnYk9_MGMqLN zlFmyfujKXCLCPyPEOIS p-4 rounded-md">
      <div class="i0EfZzmTLElZVOble53D fxZTOfUDTmJhXUzuvw8s bkn9u4HE5LeLYsQ0a0MO">
        <div class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE _WclR59Ji8jwfmjPtOei veFXkDzfJN473U3ycrV8 v93wvhik4Hi__dVhkpJC PXkJjw7zOhdtCh3e_PWh _Z_jxLj6dxcyc0eF0Vas">
          <form
            class="jCISvWkW5oStPH6Wrb_H tnci_tQZ_0ng1kTqTwHZ FLfl_xS1XCloWU2wRi87 Z6U5SEO6oB8k0BUE6Lpu VYwWi9PJwsepsh9PnOaK"
            action="#"
          >
            <h1 class="uyo8h_4Kh1IoUwm8bwJI _WfIfkoGCi0vvUrnNs4M g3OYBOqwXUEW4dRGogkH a0Ed69aMSu0vgf4oysz0">
              Welcome back
            </h1>
            <div class="neyUwteEn7DOg9pBSJJE nLBh_4HJncWRXQXC22Af __Iv72FadFpzwcpFl5_5 U4m6yFbNbl_ea9gVo2Uw _uGk0TKCucyvLBoD8KyB _rT9gacXyvSO1fCjLFak">
              <a
                href="#"
            ...
            <div>
              <label
                for="email"
                class="ttxtqsLWp2pFRX8yUvWd rD4HtsUG_hahmbh2Kj09 MxG1ClE4KPrIvlL5_Q5x _A6LflweZRUwrcL6M2Tk g3OYBOqwXUEW4dRGogkH _Rz9TooiK_4jTN_Ub8Gm"
              >
                Email
              </label>
              <input
            ...
            <div class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE _T15kfOPGkvwZnqhqKce">
              <div class="kqgYncRJQ7spwKfig6It __9yfFbPJuEYWBMy4kA9">
                <div class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE RRXFBumaW2SHdseZaWm6">
                  <input
                    id="remember"
                ...
                <div class="Ljy4iPgx864jXhJbnInL MxG1ClE4KPrIvlL5_Q5x">
                  <label
                    for="remember"
                    class="K1PPCJwslha8GUIvV_Cr _Rz9TooiK_4jTN_Ub8Gm"
                  >
                    Remember me
                  </label>
                </div>
            ...
            <p class="MxG1ClE4KPrIvlL5_Q5x XdjN1uxS_rsa3F90ox40 K1PPCJwslha8GUIvV_Cr eCx_6PNzncAD5yo7Qcic">
        ...
        <div class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE _WclR59Ji8jwfmjPtOei veFXkDzfJN473U3ycrV8 v93wvhik4Hi__dVhkpJC bg-primary-600 PXkJjw7zOhdtCh3e_PWh _Z_jxLj6dxcyc0eF0Vas bg-blue-500">
          <div class="tnci_tQZ_0ng1kTqTwHZ VYwWi9PJwsepsh9PnOaK">
            <a
              href="#"
              class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE _9OKVeTXzfSwD_NYO6_G _e063bssp_1bldcJ6kR0 LYMps1kO2vF8HBymW3az wP9HMsqy6b96l2HBRbgb"
            >
              <img
            ...
            <p class="_9OKVeTXzfSwD_NYO6_G XdjN1uxS_rsa3F90ox40 text-primary-200 F_2Dre6FGlusaaY9LAdu">
              Millions of designers and agencies around the world showcase their
              portfolio work on Flowbite - the home to the world’s best design
              and creative professionals.
            </p>
            <div class="kqgYncRJQ7spwKfig6It neyUwteEn7DOg9pBSJJE sXryjJtpSuepHYRQvdmw divide-primary-500">
              <div class="kqgYncRJQ7spwKfig6It o2Ul2ehO22E_G9Nn7M4G _LFTxJkvRWfI_UdU8mi1 TAT4_3Nxmv9bkNq4MrcJ">
                <img
                  class="bt0MUzUgiWUaZjB4iWGh _EiPZYgyUypIYjFtegNh bQPRusdUv2Wr50Lq2KOG _WlCPLL0LIv8ViOuJIFs n8e6ORKgPTnY6zgs5HS7"
              ...
              <a
                href="#"
                class="_mzhSDAYlA3W05MgSqAf wP9HMsqy6b96l2HBRbgb jpms_DMv54zgMeTI0eRM a0Ed69aMSu0vgf4oysz0"
              >
                <span class="MxG1ClE4KPrIvlL5_Q5x text-primary-200">
                  Over{" "}
                  <span class="_A6LflweZRUwrcL6M2Tk wP9HMsqy6b96l2HBRbgb">
                    15.7k
                  </span>{" "}
                  Happy Customers
                </span>
